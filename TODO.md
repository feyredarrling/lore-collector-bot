...
This is the short working list. Pick one item and start a focused Codex chat for it.
...
- Move more shared collection logic out of `index.js` when the main branch has a shared game library.
- Add more seasonal packs.
