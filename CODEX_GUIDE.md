...
- June 3 overlay updates on `main`: OBS overlay shows `NEW` for new Twitch pulls, layout tuning was synced from `overlay-playground.html`, and the playground mirrors the live overlay behavior.
